...
const int Keyboard_Impl_PC::keyCodes[] =
{
	GLFW_KEY_UNKNOWN,
	GLFW_KEY_SPACE,
	GLFW_KEY_APOSTROPHE,
...
Keyboard_Impl_PC::Keyboard_Impl_PC(Window* window)
	: window(window)
{
	currentHit.fill(false);
	preHit.fill(false);
}

Keyboard_Impl_PC::~Keyboard_Impl_PC()
{
...
InputState Keyboard_Impl_PC::GetKeyState(Keys key) const
{
