...
with aceutils.CurrentDir('../Temp'):
	...
	with aceutils.CurrentDir('glfw_bin'):
		if aceutils.isWin():
			...
			aceutils.call(r'cmake -G "Unix Makefiles" -D BUILD_SHARED_LIBS:BOOL=OFF -D CMAKE_INSTALL_PREFIX:PATH=../.. "-DCMAKE_OSX_ARCHITECTURES=x86_64;i386" ../' + pathname + '/')
			aceutils.call(r'make install')
		else:
			aceutils.call(r'cmake -G "Unix Makefiles" -D BUILD_SHARED_LIBS:BOOL=OFF -D CMAKE_INSTALL_PREFIX=../.. ../' + pathname + '/')
			aceutils.call(r'make install')
